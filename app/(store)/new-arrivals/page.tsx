  ...
  useEffect(() => {
    const fetchShopData = async () => {
      ...
      try {
        ...
        // Fetch products
        const prodQuery = query(collection(db, 'products'), where('isNewArrival', '==', true))
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="mb-8 border-b border-border pb-8">
          ...
          <p className="text-muted-foreground text-lg">
            Discover the latest and greatest products added to our catalog.
          </p>
        </div>
          ...
          <div className="flex-1">
            {loading ? (
              ...
              <div className="text-center py-20 bg-secondary/20 rounded-2xl border border-border">
                <h2 className="text-2xl font-semibold mb-2">No New Arrivals Yet</h2>
